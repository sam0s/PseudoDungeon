...
class Logos(object):
    def __init__(self,surf):
        ...
        self.time=4
        self.time2=0
        self.black = pygame.Surface((960,720))
                    ...
                    for b in self.options:
                        if b.rect.collidepoint(e.pos):
                            ...
                            if b.text == "Fullscreen":
                                b.Check()
                                pygame.display.set_mode((960, 720),HWSURFACE | DOUBLEBUF)
                                if b.active:
                                    pygame.display.set_mode((960, 720),HWSURFACE | DOUBLEBUF | FULLSCREEN)
                                self.drawn=False
